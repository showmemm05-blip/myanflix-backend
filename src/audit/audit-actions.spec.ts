...
describe('audit action catalogue', () => {
  ...
  it('covers the spec §4 catalogue exactly', () => {
    const expected = [
      ...
      'deposit.bank_match',
      'deposit.bank_screenshot_attach',
      'deposit.risk_update',
      'deposit.verification_review',
      'withdrawal.approve',
      'withdrawal.reject',
      'withdrawal.transfer_account_update',
      'withdrawal.bank_match',
      'withdrawal.bank_screenshot_attach',
      'withdrawal.risk_update',
      'withdrawal.verification_review',
